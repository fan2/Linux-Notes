...
也可将表达式重定向到 bash 内置计算器 `bc` 做计算，参考 [REDIRECTION](./../pipeline/REDIRECTION.md) 相关议题。
...
- Shell Check [SC2219](https://github.com/koalaman/shellcheck/wiki/SC2219): Instead of `let` expr, prefer `(( expr ))` .  
